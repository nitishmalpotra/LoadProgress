...
>
> 1.  **Read Context First**: Before writing any code, always read [IMPLEMENTATION_PLAN.md](docs/IMPLEMENTATION_PLAN.md) and [CODEX_PROMPTS.md](docs/CODEX_PROMPTS.md).
> 2.  **Maintain Single Source of Truth**: At the end of every prompt execution, update the status checkboxes in both the [IMPLEMENTATION_PLAN.md](docs/IMPLEMENTATION_PLAN.md) and [CODEX_PROMPTS.md](docs/CODEX_PROMPTS.md) documents to mark completed modules.
